---
title: Android SDK Dependency
sidebar_position: 2
description: Add the WebRTC Android SDK Dependency to Your Android Project
...
```mermaid
flowchart TD
    Start[Add Android SDK] --> Method{Integration Method}
    Method -->|Easy| Maven[Maven Repository]
    Method -->|Advanced| Module[Local Module]
    Maven -->|settings.gradle + build.gradle| Ready[Ready to Stream]
    Module -->|Import + Fix Errors| Ready
```
