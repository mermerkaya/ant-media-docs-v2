...
```mermaid
flowchart TD
    Client[API Client] -->|Broadcast CRUD| BS[Broadcast Service\n/APP/rest/v2/broadcasts]
    Client -->|VOD management| VS[VOD Service\n/APP/rest/v2/vods]
    Client -->|Server management| MS[Management Service\n/rest/v2]
    Client -->|Cluster ops| CS[Cluster Service\n/rest/v2/cluster]
    BS & VS & MS & CS --> AMS[Ant Media Server]
```
