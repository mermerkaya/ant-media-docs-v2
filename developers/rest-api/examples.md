...
sidebar_position: 5
description: REST API examples for Ant Media Server
...
sequenceDiagram
    ...
    Client->>AMS: POST /broadcasts/create
    AMS-->>Client: 200 {streamId, rtmpURL, status}
    Client->>AMS: GET /broadcasts/{streamId}
    AMS-->>Client: 200 Broadcast object
    Client->>AMS: PUT /broadcasts/{streamId}
    AMS-->>Client: 200 updated
    Client->>AMS: DELETE /broadcasts/{streamId}
    AMS-->>Client: 200 deleted
```
