---
title: Screen Sharing with WebRTC
sidebar_position: 7
description: Share Screen with WebRTC Using JavaScript SDK
keywords: [JavaScript SDK User Guide, Screen Sharing, Ant Media Server Documentation, Ant Media Server Tutorials]
---
...
```mermaid
flowchart LR
    Browser -->|getDisplayMedia| ScreenCapture[Screen Capture API]
    ScreenCapture -->|MediaStream| WebRTCAdaptor
    WebRTCAdaptor -->|WebRTC| AMS[Ant Media Server]
    Camera[Camera Feed] -->|switchVideoCameraCapture| WebRTCAdaptor
    ScreenCamera[Screen + Camera] -->|switchDesktopCaptureWithCamera| WebRTCAdaptor
```
