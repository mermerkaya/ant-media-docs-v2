...
```mermaid
graph TD
    A[Client connects] --> B{Measure bandwidth}
    B -->|1700 Kbps available| C[Select 1500 Kbps stream]
    B -->|900 Kbps available| D[Select 1000 Kbps stream]
    B -->|2100 Kbps available| E[Select 2000 Kbps stream]
    C --> F[Smooth playback]
    D --> F
    E --> F
```
