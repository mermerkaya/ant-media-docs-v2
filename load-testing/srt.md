...
```mermaid
flowchart LR
    Script[srt_publisher.sh] -->|spawn N ffmpeg processes| F1[FFmpeg SRT 1]
    Script --> F2[FFmpeg SRT 2]
    Script --> FN[FFmpeg SRT N]
    F1 & F2 & FN -->|SRT publish port 4200| AMS[Ant Media Server]
