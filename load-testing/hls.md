...
```mermaid
flowchart LR
    AMS[Ant Media Server] -->|HLS m3u8/ts| Script[hls_players.sh]
    Script -->|spawn N ffmpeg processes| V1[FFmpeg viewer 1]
    Script --> V2[FFmpeg viewer 2]
    Script --> VN[FFmpeg viewer N]
    V1 & V2 & VN -->|measure| Metrics[CPU / RAM / Bandwidth]
```
