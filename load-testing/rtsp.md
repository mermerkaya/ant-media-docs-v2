...
```mermaid
flowchart LR
    MP4[test.mp4] --> RTSP[GStreamer RTSP Server]
    RTSP -->|rtsp://IP:8554/test| AMS[Ant Media Server]
    AMS -->|pull N streams via REST| SS1[Stream Source 1]
    AMS --> SS2[Stream Source 2]
    AMS --> SSN[Stream Source N]
    AMS --> Dashboard[Monitor CPU/RAM/Network]
```
