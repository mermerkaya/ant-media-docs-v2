...
```mermaid
flowchart LR
    YourApp[Your Web Application] -->|embed div#root| Circle[Circle Component]
    Circle -->|WebSocket wss://| AMS[Ant Media Server]
    AMS -->|WebRTC streams| Circle
    Circle -->|renders video UI| Users[Up to 200 Participants]
```
