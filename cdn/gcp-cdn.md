...
```mermaid
flowchart LR
    P[Publisher] -->|RTMP/WebRTC| AMS[Ant Media Server on GCP]
    AMS -->|origin| LB[Cloud Load Balancer]
    LB --> CDN[Cloud CDN]
    CDN --> E1[Edge PoP - Americas]
    CDN --> E2[Edge PoP - Europe]
    CDN --> E3[Edge PoP - Asia]
    E1 --> V[Global Viewers]
    E2 --> V
    E3 --> V
```
