...
```mermaid
flowchart LR
    P[Publisher] -->|RTMP/WebRTC| AMS[Ant Media Server on AWS]
    AMS -->|HLS segments| CF[CloudFront Distribution]
    CF -->|cached content| E1[Edge Location - US]
    CF -->|cached content| E2[Edge Location - EU]
    CF -->|cached content| E3[Edge Location - APAC]
    E1 --> V1[Viewers]
    E2 --> V1
    E3 --> V1
```
