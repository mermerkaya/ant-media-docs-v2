---
title: Publish with Wirecast (RTMP)
description: Publish RTMP live stream using Wirecast to Ant Media Server.
keywords: [Wirecast RTMP, Ant Media Server Documentation, Ant Media Server Tutorials]
sidebar_position: 7
---
...
![](@site/static/img/wirecast-encoding-settings.png)
